...
<body id="login">
 <!--维护公告 start
<!-- <div style="height:30px;line-height:30px;background-color:#ff0000;color:#000;text-align:center;font-weight:bold">各位亲爱的用户，易通电商版将于2013-08-21 12:00:00到2013-08-21 13:00:00期间进行维护和升级，维护期间无法访问易通，请您提前做好工作安排，感谢您的支持和理解！</div> -->
 <!--维护公告 end -->
	<div id="contact">
