...
<form name="workForm" id="workForm" action="updateColumn.action" method="post">
	<div align="center">
        	...
        	<tr>
        		...
        		<td valign="top">
				  	<table align="left" border="0" cellpadding="6" cellspacing="6">
						<input type="hidden" name="column.columnId" value="${column.columnId }"/>
						<input type="hidden" name="column.parentColumnId" id="parentColumnId" value="${column.parentColumnId}"/>
						<input type="hidden" name="column.rootId" id="rootId" value="${column.rootId}"/>
						<input type="hidden" name="column.level" id="level" value="${column.level}"/>
						<input type="hidden" name="column.status" id="status" value="${column.status}"/>
				  		<tr>
				  			<td>栏目名称</td>
				  			<td>
				  				<input type="text" name="column.columnName" id="columnName" value="${column.columnName }" style="font-size:13px;padding:3px 3px 3px 3px;"/>
				  			</td>
				  			<td>
				  		...
				  		<tr>
				  			<td>栏目代码</td>
				  			<td>
				  				<input type="text" name="column.columnCode" id="columnCode" value="${column.columnCode }" style="font-size:13px;padding:3px 3px 3px 3px;"/>
				  			</td>
				  			<td>
				  		...
				  		<tr>
				  			<td>顺序</td>
				  			<td>
				  				<input type="text" name="column.seq" id="seq" value="${column.seq }" style="font-size:13px;padding:3px 3px 3px 3px;"/>
				  			</td>
				  			<td>
				  		...
				  		<tr>
				  			<td>备注</td>
				  			<td>
				  				<input type="text" name="column.remark" id="remark" value="${column.remark }" style="font-size:13px;padding:3px 3px 3px 3px;"/>
				  			</td>
				  			<td>&nbsp;</td>
				  		</tr>
				  		<tr>
