				...
				<table id="tbTB">
					<thead>
						<tr id="tbTH">
							...
							<th class="th_e"><div class="th_title"><em>固定电话</em></div></th>							<th class="th_d"><div class="th_title"><em>联系方式</em></div></th>
					...
					<tbody id="tbTB_TBD">
						<s:iterator value="#request.userList" status="stuts" var="usr">
							<tr>
								...
								<td class="th_e"><s:property value="#usr.telePhone"/></td>								<td class="th_d"><s:property value="#usr.mobilePhone"/><br />021-7625532</td>
								...
								<td class="th_i">
									...
									<s:elseif test="#usr.userState == 'TBA'">已激活</s:elseif>
									<s:elseif test="#usr.userState == 0">&nbsp;禁用</s:elseif>
								</td>
								<td class="th_j">
									<s:if test="#usr.userState == 1"><a href="javascript:updateUserState(${usr.id}, 0);">&nbsp;&nbsp;禁用</a> </s:if>
									<s:elseif test="#usr.userState == 'TBA'"><a href="javascript:updateUserState(${usr.id}, 0);">&nbsp;&nbsp;禁用</a></s:elseif>
									<s:elseif test="#usr.userState == 2"><a href="javascript:updateUserState(${usr.id}, 'TBA');">&nbsp;&nbsp;激活</a></s:elseif>
									<s:elseif test="#usr.userState == 0"><a href="javascript:updateUserState(${usr.id}, 'TBA');">&nbsp;&nbsp;激活</a></s:elseif><br>
