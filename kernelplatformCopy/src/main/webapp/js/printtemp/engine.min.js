...
{var str=obj.constructor.toString();var expmatch=str.match(/function\s+(\w+)/);if(expmatch&&expmatch.length==2){return expmatch[1];}}
if(obj&&obj.constructor){for(var errorname in dwr.engine._errorClasses){if(obj.constructor==dwr.engine._errorClasses[errorname])return errorname;}}
if(obj){var str=Object.prototype.toString.call(obj);var expmatch=str.match(/\[object\s+(\w+)/);if(expmatch&&expmatch.length==2){return expmatch[1];}}
