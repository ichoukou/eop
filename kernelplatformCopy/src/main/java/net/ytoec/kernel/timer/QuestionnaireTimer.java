...
public class QuestionnaireTimer extends QuartzJobBean {
	...
	throws JobExecutionException {
		...
		if (!isRunning) {
			try {
				...
				String sql = "select * from " + tablename + " partition("
						+ partition + ") where modify_time between to_date('"
	...
	public List<Questionnaire> getQuestionnaireList(ResultSet rs) throws SQLException{
		String branchId = "";
