...
public class JgCreateOrderTimerQuartz extends QuartzJobBean {
	private static Logger logger = LoggerFactory
			.getLogger(JgCreateOrderTimerQuartz.class);
	...
	public static void setPartitiondateFormat(String partitiondateFormat) {
		JgCreateOrderTimerQuartz.partitiondateFormat = partitiondateFormat;
	}
	...
	public static void setMailContentTemp(String mailContentTemp) {
		JgCreateOrderTimerQuartz.mailContentTemp = mailContentTemp;
	}
