 ...
 * 
 * MethodFilterInterceptor is an abstract <code>Interceptor</code> used as a
 * base class for interceptors that will filter execution based on method names
 ...
 * excludeMethods, it will be considered as an included method: includeMethods
 ...
 * 
 * @version $Date: 2009-12-27 19:18:29 +0100 (Sun, 27 Dec 2009) $ $Id:
 *          MethodFilterInterceptor.java 894090 2009-12-27 18:18:29Z martinc $
 */
@SuppressWarnings("serial")
public abstract class MethodFilterInterceptor extends AbstractInterceptor {
	protected transient Logger log = LoggerFactory.getLogger(MethodFilterInterceptor.class);
	...
	protected boolean applyInterceptor(ActionInvocation invocation) {
		...
		if (log.isDebugEnabled()) {
			if (!applyMethod) {
				log.debug("Skipping Interceptor... Method [" + method
