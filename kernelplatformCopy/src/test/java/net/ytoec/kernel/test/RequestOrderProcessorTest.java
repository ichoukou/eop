...
//  +"</RequestOrder>";
		...
		// 更新订单
/*		 String logisticsInterface =
		 "<UpdateInfo><txLogisticID>LP3555082300555709009</txLogisticID><logisticProviderID>YTO</logisticProviderID><mailNo></mailNo><clientID>360buy</clientID><infoType>INSTRUCTION</infoType><infoContent>UPDATE</infoContent><remark>kkk</remark></UpdateInfo>"
		 ;*/
		// 批量查询订单
//		 String logisticsInterface =
...
//		String logisticsInterface="<BatchQueryRequest>"
//		+"<logisticProviderID>YTO</logisticProviderID>"
//		+"<clientID>360buy</clientID>"
//		+"<orders>"
//		+"<order>"
//		+"<mailNo>0722981423</mailNo>"
//		+"</order>"
//		+"</orders>"
//		+"</BatchQueryRequest>";
...
//		+"<txLogisticID>LP2005032912345678 </txLogisticID>"
//		+"<mailNo>0571124563</mailNo>"
//		+"<logisticProviderID>YTO</logisticProviderID>" 
//		+"<infoType>STATUS</infoType>"
//		+"<infoContent>UNACCEPT</infoContent>"
//		+"<remark>不在取件范围</remark>"
//		+"</UpdateInfo>";
...
//		String url = "http://192.168.4.113:8080/VipOrderServlet";orderLocalProcessAction
...
//		String url = "http://localhost:8080/kernel/kingGang2TaoBao.action?clientID=360buy";
//		String url = "http://localhost:8080/kernel/kingGang2TaoBao.action?clientID=360buy";
