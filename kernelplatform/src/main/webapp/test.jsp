...
<body>
  ...
  <h5> ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑金刚接口↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑</h5>
	...
	=========================================Common=============================================
	<br>订单创建/更新/取消/查询(线上/下)(Common 支持批量)--------------二次Decode问题
	...
	面单拉取接口
	<form action="api!synWaybill.action" method="post">
<!-- 	<form action="http://service.yto56.net.cn/api!synWaybill.action" method="post"> -->
		明文
		<textarea rows='5' cols='50' name='logistics_interface' id='bbb'></textarea>
		加密文
		<textarea rows='5' cols='50' name='data_digest' id='bbb'></textarea>
		客户代码<input type='text' name='clientId' id='bbb' value="Ke0000140">
		商家秘钥<input type='text' name='parternCode' id='bbb' value="y7bZuSh7">
		...
		面单新增接口
	<form action="api!receiveWaybill.action" method="post">
		明文
		<textarea rows='5' cols='50' name='logistics_interface' id='bbb'></textarea>
		加密文
		<textarea rows='5' cols='50' name='data_digest' id='bbb'></textarea>
