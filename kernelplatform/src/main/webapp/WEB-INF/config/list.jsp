...
<%@ include file="/WEB-INF/common/meta.jsp" %>
	...
	<!-- S 当前页面 CSS -->
	<link rel="stylesheet" type="text/css" href="css/page/subConfig.css?d=${str:getVersion() }" media="all" />
	<!-- E 当前页面 CSS -->

		<!-- S Content -->
		<div id="content">
			<div id="content_hd" class="clearfix">
				<h2 id="message_icon"><s:property value="configCode.confKey"/>配置项子列表</h2>
			</div>
			<div id="content_bd" class="clearfix">
				<div class="box box_a">
					<div class="box_bd">
						<span class="btn btn_a"><a href="javascript:addNext(<s:property value="configCode.id"/>)"><input type="button" value="增加<s:property value="configCode.confKey"/>配置项"></a></span>
						<span class="btn btn_a"><a href="javascript:back(<s:property value="configCode.pid"/>)"><input type="button" value='返回上一级'></a></span>
					</div>
				</div>
				<div class="table">
					<table>
						...
						<tbody>
							<s:iterator value="dataList" id="config">
								<tr>
						            ...
						            <td>
						            	...
						            	<a href="javascript:del(<s:property value='id'/>,<s:property value="configCode.id"/>)">×</a>
						            </td>
								</tr>
							</s:iterator>
						</tbody>
	...
	<!-- S 当前页面 JS -->
	<script type="text/javascript" src="${jsPath }/page/subConfig.js?d=${str:getVersion() }"></script>
	<!-- E 当前页面 JS -->
