...
<!-- <div style="height:30px;line-height:30px;background-color:#ff0000;color:#000;text-align:center;font-weight:bold">各位亲爱的易通用户，圆通中心机房于2013年11月3日凌晨0：00至2013年11月3日上午11：00进行网络升级，此时段易通平台将停止服务，给您带来不便敬请谅解！</div> -->
	...
	<div id="contact">
			...
			<span id="qq"><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=2294882345&amp;site=qq&amp;menu=yes"><img src="images/single/qq_ico.png" alt="点击这里给我发消息" title="点击这里给我发消息" />
	...
	<!-- S Header -->
	<div id="login_header">
		<h1><a href="#" title="易通"  class="logoImg" >易通</a></h1>
		<div id="quick_tel">
		...
		<div id="login_main" class="clearfix">
			<div id="tags_cloud">
				<div id="div1">
					...
					<a href="javascript:;" class="green">活动单</a>
					<a href="javascript:;" class="yellow blod">仓配一体</a>
					<a href="javascript:;" class="green blod">快速发货</a>
				</div>
			</div>
