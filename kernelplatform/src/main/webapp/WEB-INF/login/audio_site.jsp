...
<div id="main">
	<div id="main-content">
<%-- 		<embed src='./images/flash/flvplayer.swf?file=<%=basePath %>resources/site/<s:property value="#request.jsonResult" />.flv' --%>
...
<!-- 		loop='true' menu='true'  quality='1' type='application/x-shockwave-flash'></embed> -->
		<a href='<%=basePath %>resources/site/<s:property value="#request.jsonResult" />.flv'
