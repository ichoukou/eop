      ...
      <div class="tab tab_a">
        <div class="tab_triggers">
          <ul>
            ...
            <c:if test="${yto:getCookie('userType') != 1 }"><li><a href="javascript:;">修改密码</a></li></c:if>
        ...
        <div class="tab_panels">
          <div class="tab_panel">
			<form action="user!edit.action" method="post" id="basic_info" class="form">
          ...
          <div class="tab_panel" style="display:none;">
			<form action="#" id="modify_psw" class="form">
				...
				<p>
					...
					<input type="password" id="confirm_psw" class="input_text" />
