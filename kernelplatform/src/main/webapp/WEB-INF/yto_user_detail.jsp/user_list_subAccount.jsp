...
<!-- S Content -->
  <div id="content">
    ...
    <div id="content_bd" class="clearfix"> <span class="btn btn_a">
      <input type="button" value="新增${yto:getCookie('userType') == 4 ? '客服' : '子'}帐号" onclick="location.href='user!toAddSubAccount.action'"/>
      </span>
      <div class="table">
        <table>
          <thead>
          ...
          <tbody>
            ...
            <tr>
              	<td class="td_a"><a href="user!toEditSubAccount.action?user.id=${account.id }" class="fs01">${account.userName }</a></td>
              ...
              <a href="user!toEditSubAccount.action?user.id=${account.id }" class="fs02">编辑</a>
              </td>
            </tr>
            </c:forEach>
          </tbody>
