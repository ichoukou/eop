							...
							<div id="rec_slide">
								<div id="rec_panel">
									<ul>
										...
										<li style="display:none;"><a href="http://www.ytoxl.com/FastDelivery.html" target="_blank" ><img src="${imagesPath}/single/banner6.jpg" alt="" /></a></li>
									</ul>
								</div>
								<div id="rec_trigger">
									<ul class="clearfix">
										...
										<li>
										<a href="javascript:;" title="快速发货">快速发货</a>
										</li>
									</ul>
								</div>
							</div>
