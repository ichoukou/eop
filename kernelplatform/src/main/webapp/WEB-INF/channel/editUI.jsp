							...
							<form action="channel2_edit.action" id="channel_form" class="form" method="post">
								<input type="hidden" name="channel.id" id="cId" value="${channel.id }">
									...
									<p>
										...
										<input type="text" id="lineType" name="channel.lineType" value="${channel.lineType}" class="input_text"  size="50"/>
									...
									<p>
										...
										<input type="text" id="userType" name="channel.userType" value="${channel.userType}" class="input_text"  size="50"/>
