				...
				<table id="tbTB">
					<thead>
						<tr id="tbTH">
							...
							<th class="th_d"><div class="th_title"><em>联系方式</em></div></th>
					...
					<tbody id="tbTB_TBD">
						<s:iterator value="#request.userList" status="stuts" var="usr">
							<tr>
								...
								<td class="th_d">
									<s:property value="#usr.mobilePhone"/>
									<s:if test="#usr.telePhone!=null && #usr.telePhone!=''"><br/><s:property value="#usr.telePhone"/></s:if>
								</td>
