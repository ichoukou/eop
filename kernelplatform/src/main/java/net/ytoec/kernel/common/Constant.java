...
public class Constant {
	...
	/*****面单下载界面提醒******/
	// 业务锁被锁住
	public static final String MSG_DOWNLOAD_FAST = "下载失败，此客户的面单正在拉取中，请稍后片刻(5分钟后自动解除)";
	// 网点没有有下载权限商家
	public static final String MSG_SITE_NOCUSTOMER = "您没有权限下载或者此商家不具有可下载属性，请及时联系易通管理员";
	// 面单数量不足
	public static final String MSG_WAYBILL_NOTENOUGH = "面单不足，请重新输入面单数量或重新查询最新面单情况";
	// 未知异常
	public static final String MSG_UNKOWN_ERROR = "系统未知异常，请及时联系管理员，详情如下：";
}
