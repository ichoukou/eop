	...
	private String userCreate(String xmlFragment) {
		...
		if (xmlFragment.contains("<RequestCustomerInfo")) {
			try {
				...
				/* Added by Johnson,2013-08-27  */
				if(StringUtils.isEmpty(userThread.getUserName()) || (userThread.getUserName().equals("null"))){
					userThread.setUserName(userThread.getUserCode());
				}
				/********************************/
