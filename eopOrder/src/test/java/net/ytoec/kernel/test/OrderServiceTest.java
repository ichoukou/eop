...
public class OrderServiceTest{
	...
	private static OrderService<Order> service;
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        service = (OrderService) ctx.getBean("orderServiceImpl");
    }
...
//			products.add(product11);
	...
	@Test
	public void testGent10MailNo(){
	    Map<String, Object> params = new HashMap<String, Object>();
        params.put("customerId", "e1418fa960674361acdb9ecab9914073");
        params.put("limit", 10);
	    List<String> list = service.queryTenOrdersByCustomerId(params);
