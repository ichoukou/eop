...
public class EccoreSearchIndexPressureServiceImpl implements EccoreSearchIndexPressureService {

    protected final Logger              log = LoggerFactory.getLogger(EccoreSearchIndexPressureServiceImpl.class);
    SimpleDateFormat holdTimeFormat = new SimpleDateFormat("yyyy-MM-dd");
    @Inject
    private OrderDaoIndexPressure<MailObjectDTO>   orderDaoIndexTwo;
    ...
    @Inject
    private BuildSearchStatusDaoIndexPressure<BuildSearchStatus> buildSearchStatusDaoIndexTwo;
    ...
    public void buildPartStatusWeightData(String solrUrl, Integer limit) {
        try {
            ...
            List<BuildSearchStatusWeightIndex> mailObjectDTOs = buildSearchStatusWeightIndexDao.getResultByLimitWeight1(limit);
            ...
            log.error("EccoreSearchIndexPressureServiceImpl bean set complete!");
            if (delItem.size() > 0) {
            ...
            if(limit>0) {
            	buildSearchStatusWeightIndexDao.removeBuildWeightByLimit1(minId,maxId);
            }          
