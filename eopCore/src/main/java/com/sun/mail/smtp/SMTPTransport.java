...
/*
 * @(#)SMTPTransport.java	1.80 06/02/27
 *
...
public class SMTPTransport extends Transport {
    ...
    private void issueCommand(String cmd, int expect)
				throws MessagingException {
	sendCommand(cmd);
	...
	/*if (debug)
	    out.println("DEBUG SMTP SENT(my debug123123): " + new String(cmdBytes));*/
	...
	return extMap == null ? null : (String)extMap.get(ext.toUpperCase());
    }
