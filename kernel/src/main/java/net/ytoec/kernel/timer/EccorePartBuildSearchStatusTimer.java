...
public class EccorePartBuildSearchStatusTimer extends QuartzJobBean {
    ...
    private Logger                          logger = Logger.getLogger(EccorePartBuildSearchStatusTimer.class);
    ...
    protected void executeInternal(JobExecutionContext arg0) throws JobExecutionException {
        try {
            ...
            eccoreSearchService.buildPartStatusWeightData(ConfigUtilSingle.getInstance().getSolrEccoreUrl(),limit);
            isRunning = false;
