...
public class SellerInfoServiceImpl implements SellerInfoService {
	...
	@Override
	public String searchParternBysellerUserCode(
			String sellerUserCode) {
	...
	@Override
	public String searchParternBysellerUserName(
	...
	@Override
	public String findParternByUserCodeAndShopName(
			String shopName, String userCode) {
		String s=sellerInfoDao.findParternByUserCodeAndShopName(shopName, userCode);
		return s;
	}
	...
	@Override
	public User findUserByUserCodeAndShopName(
			String shopName, String userCode) {
		User user=new User();
