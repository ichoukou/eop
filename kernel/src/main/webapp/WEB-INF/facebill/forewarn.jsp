...
window.onload = function() { 
	...
	$(function(){
		...
		$("#branckWarnValue").blur(function(){
			...
			}else if(h.test($a) && !Number($a)==Number(0)){
		...
		$("#customerWarnValue").blur(function(){
			...
			}else if(h.test($b) && !Number($b)==Number(0)){
                    ...
                    <div id="tab_panel_a" class="tab_panel clearfix">
                        <div class="pro_box clearfix">
                            <ul class="order-bar">
                                <li>
                                    <label>已用面单号总数:</label>
                                    <span style="font:700 16px/1.4 Arial;color:#61B610;text-decoration: underline;font-weight: bold;">${alreadyFaceNum }</span>
                                </li>
                                <li>
                                    <label>剩余面单号总数:</label>
                                   ...
                                   <ul class="order-box">
                                    ...
                                    <li>
                                        <span class="order-pro">
                                            ...
                                            value="${forewarn.customerWarnValue}" name="customerWarnValue" disabled="true"/></span>
