...
<!-- S Content -->
	<div id="content">
		<style type="text/css">
			...
			#question_seller_guide2{position:relative;}
			#question_seller_guide2 img{display:block;}
			#start_cus{width:130px;height:46px;display:block;position:absolute;text-indent:-9999em;overflow:hidden;left:399px;top:623px;background:url(about:blank);}
		</style>
		<form action="noint!iKnow.action" id="vip_start_form" >
			 <input type="hidden" name="menuFlag" value="chajian_question" />
			 <input name="nextAction" value="questionnaire_index" type="hidden"/>
			 <input name="methodName" value="setField003" type="hidden"/>
 		</form>
		<div id="question_seller_guide2">
			<img src="images/single/question_seller_guide2.jpg" alt="" />
...
<!-- 			 <input name="methodName" value="setField003" type="hidden"/> -->
<!--  		</form> -->
<!-- 		<img src="images/single/step01.gif" width="858" height="650"> -->
<!-- 		<input type="button" value="开始使用" id="vip_start"/> -->
<!-- 	</div> -->
