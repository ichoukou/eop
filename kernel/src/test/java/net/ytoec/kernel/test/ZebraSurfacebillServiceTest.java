...
<<<<<<< .mine
	// 测试检查商家电子面单预警
	@Test
	public void testCheckForewarn() {
		String customerCode = "1";
//		service.checkForewarn(customerCode);
	}
=======
>>>>>>> .r1253
	...
	public void testInsertBill() {
		for (int i = 0; i < 1000; i++) {
			...
			bill.setWaybillNo((800999000 + i) + "");
			bill.setOrderNo((800999000 + i) + "");
			bill.setVersionNo("1");
			bill.setFbsendStatus(0);
			bill.setFbsendDescribe("");
			bill.setFbsendTimes(1);
			bill.setPrint(false);
			bill.setUse(false);
			bill.setFbCreatedate(date);
			bill.setCurrentUserNo("K22000014");
	...
	public void testBatchInsert() {
		...
		int rows = service.batchInsert(waybillNos, customerCode);
